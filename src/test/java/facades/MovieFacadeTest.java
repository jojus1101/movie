...
public class MovieFacadeTest {
    ...
    private Movie m1 = new Movie(1933, "Hamlet", new String[]{"Hans Nielsen","Henrik Poulsen","Freddy Frok"});
    private Movie m2 = new Movie(1933, "Bambie", new String[]{"Niels Tarnose","Pia Kol","Freddy Frok"});
...
//        assertThat(movie.getActors()[0], containsString("Tornæse"));
//    }
    
    @Test
    public void testMovieHasActors(){
        Movie movie = facade.getMovieById(m1.getId());
        assertThat(movie.getActors(), arrayContaining("Hans Nielsen","Henrik Poulsen","Freddy Frok"));
    }
